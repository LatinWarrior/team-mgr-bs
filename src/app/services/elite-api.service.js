(function () {
    ...
    eliteApi.$inject = ['$http', 'appSpinner', 'clientService'];

    /* @ngInject */
    function eliteApi($http, appSpinner, client) {
        ...
        var baseUrl = client.getServiceUrl(); 
        var requestConfig = {
            headers: {
                'Content-Type': 'application/json',
                'X-ZUMO-APPLICATION': client.getZumoKey()
            }
        };
